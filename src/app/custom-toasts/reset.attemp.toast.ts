...
@Component({
  ...
  selector: '[reset-attempt-toast-component]',
  styles: [
    `
      :host {
...
export class ResetAttemptToast extends Toast {
  ...
  constructor(
    ...
    iconRegistry.addSvgIcon(
      'backup_restore',
      sanitizer.bypassSecurityTrustResourceUrl('assets/icons/settings_backup_restore_grey.svg')
    );
  }
