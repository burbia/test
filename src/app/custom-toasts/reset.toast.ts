...
@Component({
  ...
  selector: '[reset-toast-component]',
  styles: [
    `
      :host {
  ...
  justify-content: center; align-items: center; background-color: #00835A"
      >
...
export class ResetToast extends Toast {
