...
@Component({
  ...
  selector: '[reset-attempt-failed-toast-component]',
  styles: [
    `
      :host {
...
justify-content: center; align-items: center; background-color: ##FFC414"
      >
...
export class ResetAttemptFailedToast extends Toast {
  ...
  constructor(
    ...
    iconRegistry.addSvgIcon(
      'backup_restore',
      sanitizer.bypassSecurityTrustResourceUrl('assets/icons/settings_backup_restore_black.svg')
    );
  }
